---
title: "Tailrocks: tailrocks-swift-best-practices — Skill definition"
description: "Verbatim definition of tailrocks-swift-best-practices."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-best-practices/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-best-practices/references/runtime-trust.md). Load only the relevant
code reference:

| Decision | Reference |
|---|---|
| Actor isolation, Sendable values, tasks, cancellation | [`concurrency.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-best-practices/references/concurrency.md) |
| State ownership, view identity, body work, layout | [`swiftui.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-best-practices/references/swiftui.md) |
| Narrow capability-only AppKit bridge | [`appkit-interop.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-best-practices/references/appkit-interop.md) |
| Typed failure, API and availability | [`errors-and-api.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-best-practices/references/errors-and-api.md) |
| Semantics, focus, keyboard, verification IDs | [`accessibility.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-best-practices/references/accessibility.md) |
