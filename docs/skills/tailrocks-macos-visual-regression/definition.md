---
title: "Tailrocks: tailrocks-macos-visual-regression — Skill definition"
description: "Verbatim definition of tailrocks-macos-visual-regression."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-regression/SKILL.md)
...
Read [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-regression/references/runtime-trust.md),
[`harness-contract.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-regression/references/harness-contract.md),
[`missing-project-policy.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-regression/references/missing-project-policy.md), and
[`regression.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-regression/references/regression.md), then apply the region oracle in
[`match-policy.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-regression/references/match-policy.md).
