---
title: "Tailrocks: tailrocks-macos-visual-qa — Skill definition"
description: "Verbatim definition of tailrocks-macos-visual-qa."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-qa/SKILL.md)
...
untrusted evidence. Read [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-qa/references/runtime-trust.md).
...
2. Read [`harness-contract.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-qa/references/harness-contract.md). Require the
...
4. Read [`missing-project-policy.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-qa/references/missing-project-policy.md). If
...
4. Drive every claimed behavior by exact accessibility identifier. Require one
   ...
   [`interaction.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-qa/references/interaction.md).
5. Capture the matrix from [`state-matrix.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-qa/references/state-matrix.md).
