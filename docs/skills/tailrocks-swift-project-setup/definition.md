---
title: "Tailrocks: tailrocks-swift-project-setup — Skill definition"
description: "Verbatim definition of tailrocks-swift-project-setup."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-setup/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-setup/references/runtime-trust.md), then
[`shared-version-policy.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-setup/references/shared-version-policy.md). Resolve
...
2. **Write canonical baseline bytes.** Copy from [`templates/`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-setup/templates/),
...
3. **Establish project generation.** Apply
   [`project-generation.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-setup/references/project-generation.md). Use a declarative
...
4. **Pin the toolchain and SDK lanes.** Apply
   [`toolchain.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-setup/references/toolchain.md). Commit the minimum deployment
...
5. **Install strict local policy.** Apply
   [`lint-and-format.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-setup/references/lint-and-format.md) and
   [`testing.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-setup/references/testing.md). The formatter comes from Xcode; do not
