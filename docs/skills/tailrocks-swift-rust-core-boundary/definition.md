---
title: "Tailrocks: tailrocks-swift-rust-core-boundary — Skill definition"
description: "Verbatim definition of tailrocks-swift-rust-core-boundary."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-rust-core-boundary/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-rust-core-boundary/references/runtime-trust.md), then read
[`rust-core-boundary.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-rust-core-boundary/references/rust-core-boundary.md). Also read
[`apple-platform-shell.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-rust-core-boundary/references/apple-platform-shell.md) for StoreKit,
