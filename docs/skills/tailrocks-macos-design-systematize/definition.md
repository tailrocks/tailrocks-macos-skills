---
title: "Tailrocks: tailrocks-macos-design-systematize — Skill definition"
description: "Verbatim definition of tailrocks-macos-design-systematize."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design-systematize/SKILL.md)
...
Read [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design-systematize/references/runtime-trust.md),
[`reference-corpus.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design-systematize/references/reference-corpus.md), and
[`exemplars.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design-systematize/references/exemplars.md). The accepted review supplies the
