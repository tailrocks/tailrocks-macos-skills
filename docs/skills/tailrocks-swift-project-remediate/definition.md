---
title: "Tailrocks: tailrocks-swift-project-remediate — Skill definition"
description: "Verbatim definition of tailrocks-swift-project-remediate."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-remediate/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-remediate/references/runtime-trust.md),
[`shared-version-policy.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-remediate/references/shared-version-policy.md), and the four
...
2. **Select canonical policy.** Read relevant references in this order:
   [`project-generation.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-remediate/references/project-generation.md),
