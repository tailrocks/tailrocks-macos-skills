---
title: "Tailrocks: tailrocks-swift-rust-core-setup — Skill definition"
description: "Verbatim definition of tailrocks-swift-rust-core-setup."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-rust-core-setup/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-rust-core-setup/references/runtime-trust.md),
[`shared-version-policy.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-rust-core-setup/references/shared-version-policy.md), then
[`rust-core.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-rust-core-setup/references/rust-core.md).
