---
title: "Tailrocks: tailrocks-macos-visual-baseline — Skill definition"
description: "Verbatim definition of tailrocks-macos-visual-baseline."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-baseline/SKILL.md)
...
1. Derive the complete matrix from the blessing and
   [`state-matrix.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-baseline/references/state-matrix.md). Every signed-off scenario,
...
4. Write only allowlisted PNGs, capture sidecars, and `BASELINE.json`. The record
   ...
   [`baseline-metadata.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-visual-baseline/references/baseline-metadata.md).
