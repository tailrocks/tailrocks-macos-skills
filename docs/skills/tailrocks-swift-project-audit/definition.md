---
title: "Tailrocks: tailrocks-swift-project-audit — Skill definition"
description: "Verbatim definition of tailrocks-swift-project-audit."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-audit/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-audit/references/runtime-trust.md) and
[`shared-version-policy.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-audit/references/shared-version-policy.md), then the four
...
2. **Inspect generation and toolchain.** Apply
   [`project-generation.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-audit/references/project-generation.md) and
   [`toolchain.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-project-audit/references/toolchain.md). Compare declarative synchronized
