---
title: "Tailrocks: tailrocks-macos-design — Skill definition"
description: "Verbatim definition of tailrocks-macos-design."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/SKILL.md)
...
[`experience-brief.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/experience-brief.md) and the
[`ExperienceBrief.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/templates/ExperienceBrief.md) template; name the
**dominant archetype** from [`archetypes.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/archetypes.md)
...
[`native-component-map.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/native-component-map.md) and classify
every region before any styling with the
[`NativeComponentMap.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/templates/NativeComponentMap.md) template: `NATIVE`
...
[`custom-component-contract.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/custom-component-contract.md)
...
[`design-principles.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/design-principles.md). Use six to ten only when credible; stop when
...
[`prototype-package.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/prototype-package.md) govern; launch
semantics live in [`launch-contract.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/launch-contract.md).
...
derive `Regions.md` per [`match-policy.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/match-policy.md) —
...
code. Read [`platform-baseline.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/platform-baseline.md) before
any glass code; availability is the largest source of wrong output.
[`apple-patterns.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/apple-patterns.md) carries what correct looks
...
([`anti-patterns.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/anti-patterns.md) §3, the scroll-edge
...
**Layer discipline.** Read [`layer-model.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/layer-model.md) and
...
[`custom-renderers.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/custom-renderers.md).

**Implementation mechanics.** Use SwiftUI for new surfaces
([`swiftui-api.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/swiftui-api.md)); at a justified AppKit
boundary read [`appkit-api.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/appkit-api.md). The non-negotiables
...
in [`verification.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-macos-design/references/verification.md); missing live evidence stays
