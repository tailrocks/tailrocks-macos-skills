---
title: "Tailrocks: tailrocks-swift-agent-integration — Skill definition"
description: "Verbatim definition of tailrocks-swift-agent-integration."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-agent-integration/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-agent-integration/references/runtime-trust.md), then read
[`agent-integration.md`](https://github.com/tailrocks/tailrocks-macos-skills/blob/main/skills/tailrocks-swift-agent-integration/references/agent-integration.md).
